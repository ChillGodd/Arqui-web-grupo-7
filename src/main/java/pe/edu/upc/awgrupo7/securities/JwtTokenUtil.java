...
public class JwtTokenUtil  implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                .setClaims(claims)  // Añade los claims al token
                ...
                .signWith(new SecretKeySpec(Base64.getDecoder().decode(secret), SignatureAlgorithm.HS512.getJcaName()))  // Firma del token
